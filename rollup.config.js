...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-flip-timer.js',
    format: 'umd',
    globals,
    name: 'flip-timer',
    sourcemap: true,
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-flip-timer.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-flip-timer.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-flip-timer.esm.js',
    }),
  ],
};
